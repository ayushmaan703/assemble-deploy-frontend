...
export default function UsernameRecoveryViaEmail() {
    ...
    const handleUsePhone = () => {
        ...
        navigate("/UsernameRecoveryViaPhone");
    };
                ...
                <div className={`flex flex-col w-full h-auto p-3 ${dynamicGap}`}>
                    ...
                    <div className={`flex flex-col w-full h-auto ${dynamicGap}`}>
                        <div className="flex w-full gap-2">
                            ...
                            <div className="relative w-full h-12 lg:h-14 font-arialrounded rounded-xl mb-3 gap-2 bg-[#F2F2F2]">
                                <input
                                    type="email"
                                    id="email"
                                    value={email}
                                    ...
                                    placeholder=" "
                                    className={`peer w-full h-12 lg:h-14 px-4 lg:px-6 pt-5 lg:pt-6 pb-2 lg:pb-3 text-sm lg:text-base font-normal rounded-xl leading-none tracking-wider outline-none focus:outline-none focus:ring-0 ${errors.email ? 'bg-red-100 text-red-700' : 'bg-[#F2F2F2] text-gray-800'
                                        }`}
                                />
                                <label
                                    htmlFor="email"
                                    className={`absolute left-4 lg:left-6 font-arialrounded font-normal pointer-events-none transition-all duration-200 ease-in-out ${email ? 'top-1 text-[10px] lg:text-xs' : 'top-3 lg:top-4 text-sm lg:text-base'
                                        } peer-focus:top-1 peer-focus:text-[10px] lg:peer-focus:text-xs ${errors.email ? 'text-red-500' : 'text-[#737373]'
                                        }`}
                                >
                                    Email ID
                                </label>
                        ...
                        >
                            <span className="inline-block ">Continue For OTP Verification</span>
                        </button>
