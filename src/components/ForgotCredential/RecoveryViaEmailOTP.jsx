...
export default function RecoveryViaEmailOTP() {
    ...
    const handleContinue = (e) => {
        ...
        navigate("/ChangePasswordViaEmail");
    };
                    ...
                    <div className={`flex flex-col w-full h-auto ${dynamicGap}`}>
                        ...
                        <div className={`flex flex-col w-full h-auto pb-1 ${dynamicGap}`}>
                            <div className="flex flex-wrap items-center gap-1 lg:gap-2 text-left">
                                <span className="font-arialrounded font-normal text-xs leading-none tracking-wider text-black uppercase">
                                    Enter OTP for
                                </span>
                                <div className='flex items-center gap-1'>
                                    <span className="font-arialrounded font-normal text-xs leading-none tracking-wider text-[#737373]">naxnagamer2107@gmail.com</span>
                                </div>
                                <button className="font-sans font-semibold text-[10px] leading-none tracking-wider text-[#737373] hover:text-gray-700"
