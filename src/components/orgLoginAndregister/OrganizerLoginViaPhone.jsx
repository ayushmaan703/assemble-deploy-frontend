...
export default function OrganizerLoginViaPhone() {
  ...
  return (
    <div className="w-full min-h-screen h-auto flex flex-col lg:flex-row">
      ...
      <div className={`w-full lg:w-1/2 min-w-0 h-full min-h-screen flex flex-col px-6 lg:px-12 ${dynamicGap} pt-6 lg:pt-40`}>
        ...
        <div className={`w-full h-auto flex flex-col ${dynamicGap}`}>
          ...
          <div className={`flex flex-col w-full h-auto ${dynamicGap}`}>
            <div className={`flex flex-col w-full h-auto gap-2`}>
              ...
              <p className="w-full text-lg lg:text-2xl font-arialrounded font-normal leading-none tracking-normal text-black">
                Log In To Your Existing Account By Phone Number
              </p>
            </div>
            ...
            <div className={`flex flex-col w-full h-auto pb-6 ${dynamicGap}`}>
              ...
              {/* Checkbox */}
              <div className="flex flex-row items-center w-full h-auto pb-3 gap-4 lg:gap-5">
              ...
              >
                <span className="inline-block group-hover:animate-trumble">Continue With OTP</span>
              </button>
            </div>
          </div>
          ...
          <div className={`flex flex-col w-full h-auto ${dynamicGap}`}>
            ...
            {/* Email Login Button */}
            <div className="w-full h-10 lg:h-12 relative flex items-center rounded-xl pb-2 px-4 lg:px-6 gap-2 font-arialrounded font-normal text-sm lg:text-base leading-none tracking-wider justify-center text-black bg-white hover:bg-blue-50 border-2 border-[#1A1A1A] group">
              <button
                className="w-full h-4 font-arialrounded font-normal text-sm lg:text-base leading-none tracking-wider justify-center text-black group-hover:animate-trumble"
