...
export default function OrganizerRegisterViaPhoneOTP() {
      ...
      <div className={`w-full lg:w-1/2 min-w-0 h-full min-h-screen flex flex-col px-6 lg:px-12 ${dynamicGap} pt-6 lg:pt-32`}>
        ...
        <div className={`w-full h-auto flex flex-col ${dynamicGap}`}>
          ...
          <div className={`flex flex-col pb-6 w-full h-auto ${dynamicGap}`}>
            ...
            <div className={`flex flex-col w-full h-auto pb-6 ${dynamicGap}`}>
              <div className="flex flex-wrap items-center gap-1 lg:gap-2 text-left">
                ...
                <button className="font-sans font-semibold text-xs leading-none tracking-wider text-[#737373] transition-all duration-300 ease-out"
                  onClick={() => navigate("/OrganizerRegisterViaPhone")}>
                  CHANGE PHONE NUMBER
                </button>
              </div>
            ...
            >
              <span className="inline-block group-hover:animate-trumble">Start Adding Your Details</span>
            </button>
          </div>
          ...
          <div className={`flex flex-col w-full h-auto ${dynamicGap}`}>
            ...
            <div className="w-full h-10 lg:h-12 relative flex items-center rounded-xl pb-2 px-4 lg:px-6 gap-2 font-arialrounded font-normal text-sm lg:text-base leading-none tracking-wider justify-center text-black bg-white hover:bg-blue-50 border-2 border-[#1A1A1A] group">
              <div className="relative group">
                <button
                  className="w-full h-4 font-arialrounded font-normal text-sm lg:text-base leading-none tracking-wider justify-center pt-2 text-[#000000] group-hover:animate-trumble "
