...
export default function RegisterViaPhoneOTP() {
                ...
                <div className="w-full flex-1 flex flex-col">
                    <div className="flex flex-col items-center mb-3 lg:mb-4">
                        <div className="flex w-full items-center justify-between mb-4">
                            ...
                            />
                            <h2 className="lg:text-[32px] text-[20px] font-arialrounded text-center">Phone Verification</h2>
                            <img className="w-10 h-10 lg:w-12 lg:h-12" src="./Echo Elites.svg" alt="" />
                        </div>
                        <p className="text-center text-[#999999] font-normal font-arialrounded text-[10px] lg:text-base">
                            Please verify your phone number using the one-time password (OTP) provided. This step is essential to establish your identity and enhance your credibility within the esports community.
                        </p>
                    </div>
                    ...
                    <div className={`flex flex-col gap-4 lg:gap-4 flex-1 pt-6 lg:justify-center space-y-${dynamicSpacing}`}>
                        ...
                        <div className="flex flex-col w-full gap-2 lg:gap-4">
                            <div className="flex flex-wrap items-center gap-1 lg:gap-2 text-left">
                                ...
                                <div className='flex flex-row gap-1 lg:gap-2 mt-1 mb-1 lg:mb-0 lg:mt-0'><span className="font-arialrounded font-normal text-xs leading-none tracking-wider text-[#737373]">
                                    +91 - 9694993346
                                </span>
                                <button 
                            ...
                            <div className="text-center">
                                <span className="font-sans font-normal text-[14px] lg:text-base leading-normal tracking-wide text-[#0D0D0D]">
                                    Resend OTP In 00:15
                                </span>
                            </div>
                        </div>
